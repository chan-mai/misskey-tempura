...
const onlyOnOrOffNotificationTypes = ['app', 'achievementEarned', 'login', 'createToken', 'llmModerationQueue', 'scheduledNotePosted', 'scheduledNotePostFailed'] satisfies (typeof notificationTypes[number])[] as string[];
